      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
               @if(Auth::user() == true)
                  <li><a href="{{ route('userpage', ['user_id' => Auth::user()->id]) }}"><strong>{{ Auth::user()->first_name }}</strong></a></li>
                  <li class="dropdown">
                     <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">More <span class="caret"></span></a>
                     <ul class="dropdown-menu">
                        <li><a href="{{ route('account') }}">Account settings</a></li>
                        <li><a href="{{ route('events') }}">Events</a></li>
                        <li><a href="{{ route('books') }}">Offers</a></li>
                  ...
                  <li><a href="#" class="opinion" id="opinion">Submit opinion</a></li>
